...
public class AudioController {
    ...
    @Autowired
    public AudioController(AudioDAO audioDAO, RoomController roomController, ConsumptionController consumptionController, UserSecurityFunc userSecurityFunc) {
    ...
    public void createAudioDevice(AudioDTO audioDTO) throws IllegalArgumentException{
        ...
        Room room = roomController.roomExists(audioDTO.getRoomid());
    ...
    public AudioDTO getAudioDeviceById(long deviceid) throws IllegalArgumentException{
        ...
        if(userSecurityFunc.getHouseUser(audio.getRoom().getHouse().getHouseId()).isEmpty()) throw new NotFoundException("User is not part of house");
    ...
    public void deleteAudioDevice(long deviceid) throws IllegalArgumentException{
        ...
        Audio audio = audioExists(deviceid);
        if(!userSecurityFunc.checkCurrentUserIsAdmin(audio.getRoom().getHouse().getHouseId())) throw new NotFoundException("User is not admin of this house");
