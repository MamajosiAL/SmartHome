...
public class HouseDeleter implements Callback<String> {
    private final String TAG = this.getClass().getSimpleName();
    private HouseActivity context;
    private ProgressDialog progressDialog;
    private int roomId;

    public HouseDeleter(HouseActivity context) {
    ...
    private void startRequest(int houseId) {
        HouseApiInterface houseApi = getClient().create(HouseApiInterface.class);
        Call<String> call = houseApi.deleteHouse(houseId, AuthorizationManager.getInstance(context).getSessionId());
        call.enqueue(this);
    }
