...
public class DeviceStatusToggler implements Callback<String> {
    private final String TAG = this.getClass().getSimpleName();
    private DeviceActivity context;
    private ProgressDialog progressDialog;
    private int roomId;

    public DeviceStatusToggler(DeviceActivity context) {
    ...
    private void startRequest(int deviceId) {
        ...
        Call<String> call = deviceApi.changeDeviceStatus(deviceId, AuthorizationManager.getInstance(context).getSessionId());
        call.enqueue(this);
    }
    ...
    public void onResponse(Call<String> call, Response<String> response) {
        if (response != null && response.body() != null) {
            if (response.isSuccessful()) {
                ...
                Toast.makeText(context, context.getText(R.string.deviceStatusChangeSucces), Toast.LENGTH_LONG).show();
            }else {
